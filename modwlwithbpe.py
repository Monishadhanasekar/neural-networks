...
# Section 0.1: Load TinyStories Dataset
...
# Combine all stories into one text string
...
print(encode(example), "->", decode(encode(example)))
...
# --- Model Configuration for BPE tokenization ---
...
if TRAIN_MODEL:
    ...
    torch.save(model.state_dict(), "bpe_weights.pth")
    print("Model saved!")
    ...
    model.load_state_dict(torch.load("bpe_weights.pth", map_location=device))
    model.eval()
